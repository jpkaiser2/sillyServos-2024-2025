...
public class encoderDrive extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        frontLeft.setDirection(DcMotor.Direction.REVERSE);  // Only front left is reversed.
    ...
    public void movementSequence(){
        // Move forward
        encoderDrive(DRIVE_SPEED, 48, 48, 48, 48, 5.0);  // All wheels forward

        // Strafe right
        strafeDrive(DRIVE_SPEED, 24, 5.0);

        // Rotate clockwise
        encoderDrive(TURN_SPEED, 12, -12, 12, -12, 4.0);  // Rotate right

        // Move backward
        encoderDrive(DRIVE_SPEED, -24, -24, -24, -24, 4.0);  // All wheels backward
    }
